#!/bin/bash
# Run script for EECS 583 Fall 2023 PDE Project
# Place this script in the benchmarks folder and run it using the name of the file (without the file type)
# e.g. sh run.sh elmination-elimination

# ACTION NEEDED: If the path is different, please update it here.
PATH2LIB="/home/mortonal/PDE_Project/build/pdepass/pdepass.so"        # Specify your build directory in the project
